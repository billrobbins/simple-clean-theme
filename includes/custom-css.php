...
<style type='text/css'>
	...
	<?php if(of_get_option('navigation_link_color', $single = true) != ""){ ?>
		nav#main-menu li a,
		nav#main-menu li a:visited { color: <?php echo of_get_option('navigation_link_color', '' ); ?> }
	<?php } ?>
	<?php if(of_get_option('navigation_link_color_hover', $single = true) != ""){ ?>
		...
		nav#main-menu li.current-menu-item li a:hover { color: <?php echo of_get_option('navigation_link_color_hover', '' ); ?> }
	<?php } ?>
